  ...
  return (
    <header className='sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 lg:px-0'>
      <div className=' max-w-7xl mx-auto flex h-14 items-center'>
        ...
        <a href="#" className='mr-6 flex items-center space-x-2 text-white text-xl'>
  Portfolio
</a>

            {/* Menu */}
            <nav className='md:flex hidden items-center space-x-6 text-lg font-medium '>
                <a href="#about" className='transition-colors hover:text-foreground/80 text-foreground/60 text-white'>About</a>
                <a href="#projects" className='transition-colors hover:text-foreground/80 text-foreground/60  text-white'>Projects</a>
                <a href="#contact" className='transition-colors hover:text-foreground/80 text-foreground/60  text-white'>Contact</a>
            </nav>
